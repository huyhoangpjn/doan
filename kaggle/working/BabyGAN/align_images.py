...
if __name__ == "__main__":
    ...
    for img_name in os.listdir(RAW_IMAGES_DIR):
        print('Xac dinh khuon mat %s ...' % img_name)
        try:
            ...
            if os.path.isfile(fn):
                continue
            print('Bat dau tien trinh...')
            for i, face_landmarks in enumerate(landmarks_detector.get_landmarks(raw_img_path), start=1):
                try:
                    print('Bat dau len ket cac dac diem khuon mat...')
                    ...
                    print('Viet vao file %s' % aligned_face_path)
                except:
                    print("Khong the lien ket cac dac tinh khuon mat!")
